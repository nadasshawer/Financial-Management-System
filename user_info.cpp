...
void UserInfo::setFirstName(const string firstName) {
	string capitalizedFirstName = capitalizeFirstLetter(firstName); 	//capitalizing first letter of the name
...
int UserInfo::getBirthMonth()const  {
	return numericalBirthMonth;
}
...
int UserInfo::getAge()  {
	...
	if ((numericalBirthMonth > currentMonth) || (numericalBirthMonth == currentMonth && BirthDay > currentDay)) {
...
void UserInfo::setPassword(const string password) {
	Password = password;
}
...
UserInfo::UserInfo(const string cFirstName, const string cLastName, const int cBirthDay, const string cBirthMonth, const int cBirthYear, const string cUsername, const string cPassword) {
...
void UserInfo::displayUserProfile() {
	...
	cout << "- Birth Date: " << getBirthDay() << "/" << getBirthMonth() << "/" << getBirthYear() << endl;
